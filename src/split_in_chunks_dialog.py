...
class SplitDlg(QtWidgets.QDialog):
    ...
    def __init__(self, parent):
        ...
        layout.addWidget(self.chkCloud, 1.8, 4)
        layout.addWidget(self.chkClassify, 1.8, 2)
        layout.addWidget(self.chkExport, 1.8, 3)
        ...
        if export:
            for i in range(len(Metashape.app.document.chunks)):
                if i + 1 < (len(Metashape.app.document.chunks)):
                    ...
                    es_curr_chunk = Metashape.app.document.chunks[i + 1].label
